...
import com.alonedroid.smartmemo.service.SmRespawnNotificationService;
...
public class SmNotification {
    ...
    public static void notifyInputMemoNotification(Context context) {
        ...
        builder.setDeleteIntent(generateDeleteIntent(context, SmRespawnNotificationService.class));
    ...
    private static PendingIntent generateDeleteIntent(Context context, Class intentClass) {
        Intent intent = new Intent(context, intentClass);
        return PendingIntent.getService(
                context, SmRespawnNotificationService.REQUEST_CODE, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
}
